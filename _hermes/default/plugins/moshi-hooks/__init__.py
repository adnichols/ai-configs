...
HELPER = "/Users/anichols/.local/bin/moshi-hook"
...
def on_pre_tool_call(tool_name="", args=None, tool_call_id="", **kwargs):
    ...
    _send("PreToolUse", _session(kwargs=kwargs), **extra)

def on_post_tool_call(tool_name="", args=None, result=None, tool_call_id="", **kwargs):
    _send(
        "PostToolUse", _session(kwargs=kwargs),
