...
export default function deliveryReflectExtension(pi: ExtensionAPI) {
	pi.registerTool({
		...
		promptGuidelines: [
			"delivery_reflect: Call near the end of a delivery-run / run-plan / worktree workflow before DONE.",
			...
			"delivery_reflect: Guidance not gates — missing reflection must not hard-block shipping, but ending without one is discouraged.",
