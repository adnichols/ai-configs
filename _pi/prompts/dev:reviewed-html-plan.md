...
- Run the read-only active-harness reviewer-subagent plan review, then iterate plan edits and rerun the reviewer until it agrees by substance that the plan is execution-ready.
