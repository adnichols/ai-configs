...
- Do not register the plan in Doct unless the user asked to send, publish, register, or review it there.
- If the user asked for Doct or browser review, suggest:
