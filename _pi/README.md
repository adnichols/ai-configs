...
│   └── ...
├── agents/
│   ├── planner.md        # GPT-6 Sol medium; planning + independent plan-readiness review
...
- `oracle` — GPT-6 Sol high; inherited-context, read-only decision support for risky, ambiguous, drifting, or non-converging choices
- `planner` — GPT-6 Sol medium; planning plus independent read-only plan-readiness review
