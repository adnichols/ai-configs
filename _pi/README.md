...
`model-allowlist.ts` and the Pi model cycle expose exactly five routes: `openai-codex/gpt-5.6-terra`, `openai-codex/gpt-5.6-luna`, `openai-codex/gpt-5.6-sol`, `xai/grok-4.5`, and `opencode/deepseek-v4-flash`. It filters the live model catalog again after Pi refreshes it. The extension uses Pi's current internal model collection because Pi does not expose a public global model-registry allowlist; verify it after a Pi upgrade.
