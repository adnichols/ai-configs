...
EXPECTED_LOCAL_DIFFS=(
  ...
  "src/core/build-sections.ts|preserve local tool-error outstanding-context behavior plus local intent/commit wiring"
  ...
  "src/extract/commits.ts|adapt upstream commits section feature to local session-evidence contract"
  ...
  "src/sections.ts|preserve local summary contract with intent and commit additions"
  ...
  "tests/compile.test.ts|approved wrapping tests plus local final redaction, intent, pruning, and commit tests"
