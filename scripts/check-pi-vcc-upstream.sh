...
EXPECTED_LOCAL_DIFFS=(
  ...
  "src/core/summarize.ts|approved wrapping uptake while preserving final redaction and local summary contract"
  ...
  "src/hooks/before-compact.ts|preserve native retention integration, marker behavior, intent parsing, and deterministic summary hook"
