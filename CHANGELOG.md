...
- Synced managed OMP `config.yml` from this host: `slow` is `openai-codex/gpt-6-astra:medium`, `Oracle` is `openai-codex/gpt-6-astra:high`, `designer` is `devin/claude-fable-5-1:medium`. `prewalk.enabled` is false.
