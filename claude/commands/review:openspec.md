...
You are **Claude** reviewing this OpenSpec change. All comments you add must be clearly attributed to you.
...
```markdown
[REVIEW:Claude] SECTION "Section Title": Your critical feedback here. Be specific and actionable. [/REVIEW]
```

For `tasks.md`, prefer line-referenced tags:

```markdown
[REVIEW:Claude] LINE 42: INCORRECT: Task says X but delta specs require Y. [/REVIEW]
```
