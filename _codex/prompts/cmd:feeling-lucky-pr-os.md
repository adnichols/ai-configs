---
description: End-to-end autopilot from a FeelingLucky Linear issue to a pushed PR using Open Source stack
...
```bash
pi -p --approve "/cmd:feeling-lucky-pr-os $ARGUMENTS"
```
