---
description: Run the Pi PRD clarification round with critical-thinker support
argument-hint: '<prd path | prd slug | source request>'
---
...
```bash
pi -p --approve "/prd:clarify-round $ARGUMENTS"
```
