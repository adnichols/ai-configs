...
- Apply the canonical conditional planning-evidence checkpoint: when exact-contract, distributed-behavior, or material-uncertainty triggers apply, put consumer/sibling evidence, moving-ground checks, falsification and production-path proof, residual risk, and expansion disposition in existing review sections.
- Goal / Non-goals
