...
- Keep the reusable script or transformation in the task repository when the task calls for a maintained artifact. Use native Codex execution and editing tools.
