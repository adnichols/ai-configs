...
tokens={
'pre-pr-implementation':{'FINDINGS_TO_RESOLVE','PASS','CLEAN_FOR_PR','BLOCKED_BY_QUESTION','REVIEW_INCOMPLETE_RERUN_NEEDED'},
'generic-implementation':{'FINDINGS_TO_RESOLVE','PASS','CLEAN_FOR_PR','BLOCKED_BY_QUESTION','REVIEW_INCOMPLETE_RERUN_NEEDED'},
'run-plan-pm':{'PASS','PASS_SCOPED','PASS_WITH_DOCUMENTED_OUT_OF_SCOPE_FOLLOW_UPS','FINDINGS_TO_RESOLVE','FIX_IN_SCOPE_FINDINGS','BLOCKED_BY_QUESTION','BLOCKED_BY_SCOPE_QUESTION','REVIEW_INCOMPLETE_RERUN_NEEDED'},
