...
description: "Create a project-local skill for exercising and verifying real UI, CLI, or service behavior."
---
...
If the checkout does not build or start as-is, repair it only within the authorized scope or report the blocker before generating; a skill written against a broken base teaches wrong steps. When an irrelevant missing asset blocks startup (a static dir the API never serves, a sample config), the generated skill may create it, clearly marked as verification scaffolding, and remove it in cleanup.
