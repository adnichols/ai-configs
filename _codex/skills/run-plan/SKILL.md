...
4. Compare the finished behavior with the plan as a product-outcome review. Run `autoreview` for independent material review, counting earlier equivalent review of the unchanged candidate once. The driver runs tests and fixes findings.
