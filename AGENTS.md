...
- Agent frontmatter is authoritative: Oracle decision support uses GPT-5.6 Sol high with inherited context; planning and independent plan-readiness review use GPT-5.6 Sol medium; implementation/code review uses GPT-5.6 Terra medium; scout uses GPT-5.6 Terra low.
