...
- `quality-reviewer-glm` (ollama/glm-5.2:cloud; `_pi/agents/quality-reviewer-glm.md`) — Independent Pi GLM review gate for scoped implementation, execution-ready plan reviews, and the pre-PR GPT/GLM gate.
