...
- `/skill:pre-pr-implementation-review` — Run GPT-5.5 plus OpenCode Zen GLM-5 pre-PR implementation review until in-scope P1/P2/P3 findings are addressed; inside `scoped-plan-run` it hands back to mandatory PR creation instead of concluding.
