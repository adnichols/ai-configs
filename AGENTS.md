...
- Required code review uses the active runtime's configured reviewer. Completeness is opt-in. Read the local planning skill for review budgets and plan execution.
