...
ADN_RUNTIME_MARKER:why:46756f89270d7e7dcb8c28c90fd0f957ade4ce2c
...
- `model`: your configured why-investigators model (default `grok-4.6:high`)
...
- `subagent_type`: `generalPurpose`
- `model`: your configured why-synthesizer model (default `kimi-k3-max`)
