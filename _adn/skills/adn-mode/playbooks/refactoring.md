ADN_RUNTIME_MARKER:playbook-refactoring:ecc249f1e306fc64ddf83c7bed16cacf7c2239db
...
8. Rebase into small ordered commits. A subtraction commit, then the reshape, then any follow-on cleanup. Shape them with the **sequence-verifiable-units** principle skill, so each behavior-preserving slice stays green before the next. Run **Opening a PR** (`playbooks/opening-a-pr.md`).
