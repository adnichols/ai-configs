...
ADN_RUNTIME_MARKER:automate-me:ecc249f1e306fc64ddf83c7bed16cacf7c2239db
...
Mining misses intent that hasn't come up yet. Use the `operator question` tool (structured multi-choice) rather than asking the user to type from scratch.
