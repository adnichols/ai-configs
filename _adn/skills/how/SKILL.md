...
ADN_RUNTIME_MARKER:how:46756f89270d7e7dcb8c28c90fd0f957ade4ce2c
...
- `model`: your configured how-explorer model (default `grok-4.6:high`)
- `readonly`: `true`
...
- `subagent_type`: `generalPurpose`
- `model`: your configured how-explainer model (default `kimi-k3-max`)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `kimi-k3-max`, `gpt-5.6-sol-max`, `grok-4.6:high`, `claude-opus-5-thinking-xhigh`), all in a single message.
