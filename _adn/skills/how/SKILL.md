...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `kimi-k3-max`, `gpt-5.6-sol-max`, `grok-4.6-fast-xhigh`, `claude-opus-5-thinking-xhigh`), all in a single message.
