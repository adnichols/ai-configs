...
ADN_RUNTIME_MARKER:architect:ecc249f1e306fc64ddf83c7bed16cacf7c2239db
...
Take the runners from the `architect runners` line in the `pstack-models.mdc` rule, in place of the `arena runners` line. If the rule or that line is missing, use `kimi-k3-max`, `gpt-5.6-sol-max`, `grok-4.6:high`, `claude-opus-5-thinking-xhigh`. Alias and rejected entries follow the runner rules in the **arena** skill's Phase A.
