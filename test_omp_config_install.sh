...
cmp -s "$REPO_ROOT/_omp/extensions/paseo-terminal-status.ts" "$TARGET_ROOT/extensions/paseo-terminal-status.ts"
...
cmp -s "$REPO_ROOT/_adn/skills/adn-mode/references/omp-runtime.md" "$TARGET_ROOT/skills/adn-mode/references/omp-runtime.md"
